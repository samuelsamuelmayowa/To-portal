        ...
        >
          <div>
            ...
            <p className="mt-5 max-w-2xl text-lg font-medium leading-8 text-slate-300">
              ...
              with $100,000 in virtual buying powerâ€”without risking real money.
            </p>
            ...
            >
              ...
              <span className="ml-3 text-xl" aria-hidden="true">â†’</span>
            </Link>
          ...
          <motion.div variants={fadeUp} className="mt-12">
            ...
            >
              <SplideSlide>
                <div className="mx-auto max-w-4xl rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm md:p-12">
                  <p className="text-2xl font-bold leading-10 text-slate-800 md:text-3xl">
                    â€œThe mentorship helped me break into a Splunk Admin role
                    with confidence.â€
                  </p>
                  <p className="mt-6 font-black text-BLUE">â€” Splunk Admin</p>
                </div>
              </SplideSlide>
              ...
              <SplideSlide>
                <div className="mx-auto max-w-4xl rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm md:p-12">
                  <p className="text-2xl font-bold leading-10 text-slate-800 md:text-3xl">
                    â€œFrom zero IT experience to job-ready. The labs and 1:1
                    sessions were game-changers.â€
                  </p>
              ...
              <SplideSlide>
                <div className="mx-auto max-w-4xl rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm md:p-12">
                  <p className="text-2xl font-bold leading-10 text-slate-800 md:text-3xl">
                    â€œLanded a SOC Analyst role in 7 weeks â€” coming from
                    customer service.â€
                  </p>
                  <p className="mt-6 font-black text-BLUE">â€” SOC Analyst</p>
                </div>
              </SplideSlide>
            </Splide>
          </motion.div>
