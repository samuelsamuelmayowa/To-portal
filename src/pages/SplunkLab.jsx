  ...
  const revealHint = async () => {
    ...
    if (attemptId && connection === "online") {
      try {
        ...
        setHints((value) => ({
          ...value,
          [mission.id]: result.hint || mission.hint,
        }));
        return;
      } catch (error) {
        setApiMessage(
    ...
    setHints((value) => ({ ...value, [mission.id]: mission.hint }));
  };
