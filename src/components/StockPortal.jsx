...
const sampleCourses = [
  {
    ...
    classes: [
      ...
      {
        id: "class2",
        title: "Class 1 — Stock & Options  SIEM (1 Videos)",
        videos: [
          {
            id: "v2",
            title: "To-analytics Stock & Options Class 1",
        ...
        docs: [
          {
            id: "d1",
            title: "To-analytics Stock & Options Class 1 Intro",
            url: "https://drive.google.com/file/d/1bf5cRkcEC3yDJ5MnzpRKDpRLhRhdUH90/preview",
          },
          {
            id: "d2",
            title: "To-analytics Stock & Options Class 1 Note",
      ...
      {
        id: "class3",
        title: "Class 2 —  Stock & Options Basics",
        videos: [
          {
            id: "v2",
            title: "To-analytics Stock & Options Class 2",
        ...
        docs: [
          ...
          {
            id: "d4",
            title: "To-analytics Stock & Options  Class 2 Note",
      ...
      {
        id: "class4",
        title: "Class 3 — Stock & Options SPL",
        videos: [
          {
            id: "v2",
            title: "To-analytics Stock & Options Class 3",
        ...
        docs: [
          ...
          {
            id: "d4",
            title: "To-analytics Stock & Options Class 3 Note",
      ...
      },
      {
        ...
        videos: [
          {
            id: "v2",
            title: "To-analytics Stock & Options Class 4",
      ...
      {
        id: "class6",
        title: "Class 5  — Stock & Options SPL  LAB",
        desc: "Creating reports, dashboards, visualizations, inputs and filters. .",
        videos: [
          {
            id: "v2",
            title: "To-analytics Stock & Options Class 5",
        ...
        docs: [
          {
            id: "d3",
            title: "Stock & Options Class 5 Slides",
            url: "",
          ...
          {
            id: "d3",
            title: "Stock & Options Class 5 Note",
      ...
      {
        id: "class8",
        title: "Class 6  — Stock & Options Knowledge Objects.",
        desc: "",
        videos: [
          {
            id: "v2",
            title: "To-analytics Stock & Options Class 6",
      ...
      {
        id: "class7",
        // title: "Class 7  —  Stock & Options Dashboard",
        title: "Class 7 Stock & Options Lab Knowledge Objects",
        desc: "",
        videos: [
          {
            id: "v2",
            title: "To-analytics Stock & Options Class 7",
      ...
      // https://player.vimeo.com/video/1149696096
      {
        id: "class8",
        // title: "Class 7  —  Stock & Options Dashboard",
        title: "Class 8 Stock & Options Dashboard ",
        desc: "",
        videos: [
          {
            id: "v2",
            title: "To-analytics Stock & Options Class 8",
...

      {
        id: "class9",
        // title: "Class 7  —  Stock & Options Dashboard",
        title: "Class 9 Stock & Options Dashboard Lab",
        desc: "",
        videos: [
          {
            id: "v2",
            title: "To-analytics Stock & Options Class 9",
...

      {
        ...
        videos: [
          {
            id: "v2",
            title: "To-analytics Stock & Options Class 10",
...
const fullStock & OptionsSyllabus = sampleCourses
  .find((c) => c.id === "stock")
...
function SyllabusSection({ onSelectClass }) {
  return (
    <div className="space-y-5">
      {fullStock & OptionsSyllabus.map((week, index) => {
          ...
          <div className="flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
            <div>
              ...
              <h1 className="mt-5 text-3xl font-black tracking-tight md:text-5xl">
                Professional Stock & Options Bootcamp Dashboard
              </h1>
