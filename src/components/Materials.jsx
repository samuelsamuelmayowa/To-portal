...
export const fullSplunkSyllabus = [
  {
    week: 1,
    title: "Splunk Orientation & Setup",
    desc: "Introduction to Splunk, real-world use cases, SOC overview, and installing Splunk Enterprise.",
    videos: [],
    docs: [],
  },
  {
    week: 2,
    title: "Splunk Interface & First Searches",
    desc: "Navigating Splunk Web, adding sample data, basic searches, time range selection, and fields panel.",
    videos: [],
    docs: [],
  },
  {
    week: 3,
    title: "Core SPL Fundamentals",
    desc: "Using search, fields, table, sort, dedup, stats, count, and basic filtering techniques.",
    videos: [],
    docs: [],
  },
  {
    week: 4,
    title: "SPL for Analysis (Hands-on)",
    desc: "eval, where, rex, case, if statements, formatting results, and real log analysis.",
    videos: [],
    docs: [],
  },
  {
    week: 5,
    title: "Lookups, Transactions & Correlation",
    desc: "CSV lookups, automatic lookups, transactions, correlating events, and enrichment.",
    videos: [],
    docs: [],
  },
  {
    week: 6,
    title: "Reports & Dashboards (Practical)",
    desc: "Creating reports, dashboard panels, charts, tables, tokens, and dashboard inputs.",
    videos: [],
    docs: [],
  },
  {
    week: 7,
    title: "Alerts & Monitoring",
    desc: "Scheduled vs real-time alerts, alert triggers, throttling, email alerts, and SOC use cases.",
    videos: [],
    docs: [],
  },
  {
    week: 8,
    title: "Splunk Apps & Add-ons",
    desc: "Installing apps from Splunkbase, Splunk App for Windows/Linux, and basic configuration.",
    videos: [],
    docs: [],
  },
  {
    week: 9,
    title: "Data Inputs & Forwarders",
    desc: "File monitoring, directory inputs, Universal Forwarder setup, and indexing pipeline basics.",
    videos: [],
    docs: [],
  },
  {
    week: 10,
    title: "User Roles, Security & Permissions",
    desc: "Users and roles, RBAC, authentication basics, securing Splunk, and best practices.",
    videos: [],
    docs: [],
  },
  {
    week: 11,
    title: "Advanced SPL & SOC Searches",
    desc: "Subsearches, joins, macros, workflow actions, and security-focused SPL queries.",
    videos: [],
    docs: [],
  },
  {
    ...
    desc: "Optimizing searches, indexing best practices, common errors, and Splunk troubleshooting.",
    videos: [],
    docs: [],
  },
  {
    ...
    desc: "Indexer clusters, search head clusters, deployment concepts, and high availability.",
    videos: [],
    docs: [],
  },
  {
    week: 14,
    title: "Final Project, Exam & Career Prep",
    desc: "Capstone dashboard + alert project, exam review, interview questions, and job guidance.",
    videos: [],
    docs: [],
  },
];
