...
const MainQuiz = () => {
  ...
  useEffect(() => {
    if (isAllowed) {
      fetch("https://to-backendapi-v1-kctb.onrender.com/api/assignment")
        .then((res) => res.json())
        .then((data) => {
      ...
      <div className="grid md:grid-cols-5 gap-10 max-w-7xl mx-auto">
        ...
        >
          ...
          >
            ...
            <option value="T.O Analytics Splunk Class 7 Quiz">
              Splunk Class 7 Quiz
            </option>
            <option value="T.O Analytics  Splunk Class 9 Quiz">
              Splunk Class 9 Quiz
            </option>

            <option value="T.O Analytics Splunk Class  12 Quiz">
              {" "}
              T.O Analytics Splunk Class 12 Quiz
            </option>
            {isBoss && (
