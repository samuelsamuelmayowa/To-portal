...
const mapData = [
  {
    ...
    description: "Core Splunk concepts & architecture",
    items: [
      "What is Splunk?",
      "Indexer / Search Head",
      "Forwarders",
  ...
  },
  {
    ...
    description: "Search Processing Language mastery",
    items: ["search", "stats", "eval", "timechart", "real log analysis"],
  },
  {
    title: "Dashboard Studio",
    icon: BarChart3,
    color: "from-emerald-500 to-teal-600",
    description: "Build modern dashboards",
    items: ["Panels", "Tokens", "Drilldowns", "Best practices"],
  },
  {
  ...
  },
  {
    ...
    description: "Reusable Splunk logic",
    items: ["Lookups", "Event types", "Tags", "Macros"],
  },
  {
    title: "SOC / Security Path",
    icon: ShieldCheck,
    color: "from-red-600 to-rose-700",
    description: "Cybersecurity use cases",
    items: [
